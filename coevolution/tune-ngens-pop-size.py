...
def main():
    ...
    for POP_SIZE in pop_sizes:
        ...
        for g in range(NGEN):
            ...
            best_player_current = sorted(selfish_population + cooperative_population + communal_population + selfless_population, key=lambda member: member[1], reverse=True)[1]
            current_best_score = best_player_current[1] / float(best_player_current[4])
            best_players[POP_SIZE].append(current_best_score)
