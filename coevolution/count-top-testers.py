...
def main():
    ...
    num_best = 20
    best_tested = []
    best_count = []         # count for each objective pair in top members each time testing performed
    ...
    for POP_SIZE in pop_sizes:
        ...
        for g in range(NGEN):
            ...
            if g % 10 == 9:
                ...
                # list of counts for each obj pair for top members this generation
                gen_best_count = [0, 0, 0, 0]
                ...
                # get count of each obj pair in sorted_test_self
                # and add to best_tested
                ...
                best_count.append(deepcopy(gen_best_count))
        ...
        print("Count of best tested members by test generation:")
        for e in best_count:
            print("   {}".format(e))
        print()
        ...
        timestr += '.csv'
        deapplaygame.exportGenometoCSV(timestr, all_ind, run_info, test_pops, test_labels, best_tested, best_count)
